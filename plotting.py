...
INPUT_FILE = 'system_metrics_20250909_095831.csv'
...
def plot_system_metrics(input_filename=INPUT_FILE):
    ...
    # 1. Memory Usage
    ax1 = axes[0, 0]
    ax1.plot(df['Timestamp'].values, df['memory_usage'].values * df['total_memory'].values / 100 / (1024**3), 'b-', linewidth=2, label='Memory Usage')
    ...
    ax1_solo.plot(df['Timestamp'].values, df['memory_usage'].values * df['total_memory'].values / 100 / (1024**3), 'b-', linewidth=2, label='Memory Usage')
    ...
    ax1_solo.xaxis.set_major_locator(mdates.SecondLocator(interval=2))
    ...
    ax2_solo.xaxis.set_major_locator(mdates.SecondLocator(interval=2))
    ax2_solo.set_ylim(0, 100)
    ...
    ax3_solo.xaxis.set_major_locator(mdates.SecondLocator(interval=2))
    ...
    ax4_solo.xaxis.set_major_locator(mdates.SecondLocator(interval=2))
    ...
    ax5.xaxis.set_major_locator(mdates.SecondLocator(interval=2))
    ...
    ax5_solo.xaxis.set_major_locator(mdates.SecondLocator(interval=2))
    ...
    ax6.xaxis.set_major_locator(mdates.SecondLocator(interval=2))
    ax6.set_ylim(0, 100)
    ...
    ax6_solo.xaxis.set_major_locator(mdates.SecondLocator(interval=2))
    ax6_solo.set_ylim(0, 100)
