# /home/isabel/YOLO/bach_metrics/new_analyzer/profiler_system/logs/20260115_e_cores/system_metrics_20260115_160530.csv
...
# Load CSV
csv_path = "/home/isabel/YOLO/bach_metrics/new_analyzer/profiler_system/logs/20260115_e_cores/system_metrics_20260115_160530.csv"
...
plt.savefig('/home/isabel/catkin_ws/histograms/e_core_frequency_count_histogram.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.tight_layout()
plt.savefig('/home/isabel/catkin_ws/histograms/e_core_frequency_average_histogram.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.tight_layout()
plt.savefig('/home/isabel/catkin_ws/histograms/e_cores_active_average_usage_histogram.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.tight_layout()
plt.savefig('/home/isabel/catkin_ws/histograms/e_cores_active_histogram.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig('/home/isabel/catkin_ws/histograms/e_cores_active_average_usage_p_and_e_core_histogram.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('/home/isabel/catkin_ws/histograms/e_core_frequency_histogram.png', dpi=300, bbox_inches='tight')
plt.show()
